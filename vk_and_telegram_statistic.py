...
def main():
    ...
    telegram_groups = ['topor','arh_29ru','piterach','Cbpub','bazabazon']
    ...
    result_text_vk.insert(tk.END, "Анализ данных в VK завершен. Результаты сохранены в текстовом поле.")
    result_text_telegram.insert(tk.END, "Анализ данных в Telegram завершен. Результаты сохранены в текстовом поле.")
